...
const baseQueryTraceTxRequest: object = { blockNumber: 0, blockHash: '' }
...
export const QueryTraceTxRequest = {
  ...
  toJSON(message: QueryTraceTxRequest): unknown {
    ...
    message.blockTime !== undefined &&
      (obj.blockTime = message.blockTime !== undefined ? message.blockTime.toISOString() : null)
    return obj
  },
...
const baseQueryTraceBlockRequest: object = { blockNumber: 0, blockHash: '' }

export const QueryTraceBlockRequest = {
  encode(message: QueryTraceBlockRequest, writer: Writer = Writer.create()): Writer {
...
export const QueryTraceBlockResponse = {
  encode(message: QueryTraceBlockResponse, writer: Writer = Writer.create()): Writer {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data)
    }
    return writer
