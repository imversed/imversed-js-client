...
const baseGenesisState: object = { blockGas: 0 };
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 3:
          message.blockGas = longToNumber(reader.uint64() as Long);
          break;
        default:
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (object.blockGas !== undefined && object.blockGas !== null) {
      message.blockGas = Number(object.blockGas);
    } else {
      message.blockGas = 0;
    }
    return message;
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.blockGas !== undefined && (obj.blockGas = message.blockGas);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (object.blockGas !== undefined && object.blockGas !== null) {
      message.blockGas = object.blockGas;
    } else {
      message.blockGas = 0;
    }
    return message;
