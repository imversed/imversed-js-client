...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (
      ...
      message.baseFeeChangeDenominator = Number(
        object.baseFeeChangeDenominator
      );
    } else {
    ...
    if (object.minGasPrice !== undefined && object.minGasPrice !== null) {
      message.minGasPrice = String(object.minGasPrice);
    } else {
      message.minGasPrice = "";
    }
    if (
      object.minGasMultiplier !== undefined &&
      object.minGasMultiplier !== null
    ) {
      message.minGasMultiplier = String(object.minGasMultiplier);
    } else {
  ...
  toJSON(message: Params): unknown {
    ...
    message.enableHeight !== undefined &&
      (obj.enableHeight = message.enableHeight);
