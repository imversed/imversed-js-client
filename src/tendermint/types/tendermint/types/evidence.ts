...
const baseDuplicateVoteEvidence: object = { totalVotingPower: 0, validatorPower: 0 }
...
const baseLightClientAttackEvidence: object = { commonHeight: 0, totalVotingPower: 0 }
