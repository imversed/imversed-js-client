...
export const QueryPoolsResponse = {
  encode(message: QueryPoolsResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryNumPoolsResponse = {
  encode(message: QueryNumPoolsResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryPoolParamsRequest = {
  encode(message: QueryPoolParamsRequest, writer: Writer = Writer.create()): Writer {
    if (message.poolId !== 0) {
      writer.uint32(8).uint64(message.poolId)
    }
    return writer
...
export const QueryPoolParamsResponse = {
  encode(message: QueryPoolParamsResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryPoolParamsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryPoolParamsResponse } as QueryPoolParamsResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryPoolParamsResponse): unknown {
    const obj: any = {}
    message.params !== undefined &&
      (obj.params = message.params ? PoolParams.toJSON(message.params) : undefined)
    return obj
  },
...
export const QueryTotalSharesRequest = {
  encode(message: QueryTotalSharesRequest, writer: Writer = Writer.create()): Writer {
    if (message.poolId !== 0) {
      writer.uint32(8).uint64(message.poolId)
    }
    return writer
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryTotalSharesRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryTotalSharesRequest } as QueryTotalSharesRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const QueryTotalSharesResponse = {
  encode(message: QueryTotalSharesResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryTotalSharesResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryTotalSharesResponse } as QueryTotalSharesResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseQueryPoolAssetsRequest: object = { poolId: 0 }

export const QueryPoolAssetsRequest = {
  encode(message: QueryPoolAssetsRequest, writer: Writer = Writer.create()): Writer {
    if (message.poolId !== 0) {
      writer.uint32(8).uint64(message.poolId)
    }
    return writer
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryPoolAssetsRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryPoolAssetsRequest } as QueryPoolAssetsRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseQueryPoolAssetsResponse: object = {}

export const QueryPoolAssetsResponse = {
  encode(message: QueryPoolAssetsResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryPoolAssetsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryPoolAssetsResponse } as QueryPoolAssetsResponse
    message.poolAssets = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
...
export const QuerySpotPriceRequest = {
  encode(message: QuerySpotPriceRequest, writer: Writer = Writer.create()): Writer {
    if (message.poolId !== 0) {
      writer.uint32(8).uint64(message.poolId)
    }
...
export const QuerySpotPriceResponse = {
  encode(message: QuerySpotPriceResponse, writer: Writer = Writer.create()): Writer {
...
const baseQuerySwapExactAmountInRequest: object = { sender: '', poolId: 0, tokenIn: '' }

export const QuerySwapExactAmountInRequest = {
  encode(message: QuerySwapExactAmountInRequest, writer: Writer = Writer.create()): Writer {
    if (message.sender !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): QuerySwapExactAmountInRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQuerySwapExactAmountInRequest } as QuerySwapExactAmountInRequest
    message.routes = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
...
export const QuerySwapExactAmountInResponse = {
  encode(message: QuerySwapExactAmountInResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QuerySwapExactAmountInResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQuerySwapExactAmountInResponse } as QuerySwapExactAmountInResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseQuerySwapExactAmountOutRequest: object = { sender: '', poolId: 0, tokenOut: '' }

export const QuerySwapExactAmountOutRequest = {
  encode(message: QuerySwapExactAmountOutRequest, writer: Writer = Writer.create()): Writer {
    if (message.sender !== '') {
      writer.uint32(10).string(message.sender)
    }
    if (message.poolId !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): QuerySwapExactAmountOutRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQuerySwapExactAmountOutRequest } as QuerySwapExactAmountOutRequest
    message.routes = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
...
export const QuerySwapExactAmountOutResponse = {
  encode(message: QuerySwapExactAmountOutResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QuerySwapExactAmountOutResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQuerySwapExactAmountOutResponse } as QuerySwapExactAmountOutResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const QueryTotalLiquidityRequest = {
  encode(_: QueryTotalLiquidityRequest, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryTotalLiquidityRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryTotalLiquidityRequest } as QueryTotalLiquidityRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
export const QueryTotalLiquidityResponse = {
  encode(message: QueryTotalLiquidityResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryTotalLiquidityResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryTotalLiquidityResponse } as QueryTotalLiquidityResponse
    message.liquidity = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
