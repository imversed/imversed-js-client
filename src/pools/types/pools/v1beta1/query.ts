...
export const QueryPoolAssetsRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryPoolAssetsRequest>
...
export const QueryPoolAssetsResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryPoolAssetsResponse>
...
export class QueryClientImpl implements Query {
  ...
  PoolAssets(
    ...
    return promise.then((data) =>
      QueryPoolAssetsResponse.decode(new Reader(data))
    );
  }
