...
export const QueryGetCurrencyRequest = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetCurrencyRequest {
    ...
    const message = {
      ...baseQueryGetCurrencyRequest,
    } as QueryGetCurrencyRequest;
  ...
  fromPartial(
    object: DeepPartial<QueryGetCurrencyRequest>
  ): QueryGetCurrencyRequest {
    const message = {
      ...baseQueryGetCurrencyRequest,
    } as QueryGetCurrencyRequest;
    if (object.denom !== undefined && object.denom !== null) {
...
export const QueryGetCurrencyResponse = {
  ...
  decode(
    ...
    length?: number
  ): QueryGetCurrencyResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetCurrencyResponse,
    } as QueryGetCurrencyResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetCurrencyResponse>
  ): QueryGetCurrencyResponse {
    const message = {
      ...baseQueryGetCurrencyResponse,
    } as QueryGetCurrencyResponse;
...
export const QueryAllCurrencyRequest = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryAllCurrencyRequest {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllCurrencyRequest,
    } as QueryAllCurrencyRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllCurrencyRequest>
...
export const QueryAllCurrencyResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllCurrencyResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllCurrencyResponse,
    } as QueryAllCurrencyResponse;
    message.currency = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: QueryAllCurrencyResponse): unknown {
    const obj: any = {};
    if (message.currency) {
      obj.currency = message.currency.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryAllCurrencyResponse>
  ): QueryAllCurrencyResponse {
    const message = {
      ...baseQueryAllCurrencyResponse,
    } as QueryAllCurrencyResponse;
...
export interface Query {
  ...
  CurrencyAll(
    request: QueryAllCurrencyRequest
  ): Promise<QueryAllCurrencyResponse>;
...
export class QueryClientImpl implements Query {
  ...
  Currency(
    request: QueryGetCurrencyRequest
  ): Promise<QueryGetCurrencyResponse> {
    const data = QueryGetCurrencyRequest.encode(request).finish();
    const promise = this.rpc.request(
      "fulldivevr.imversed.currency.Query",
      "Currency",
      data
    );
    return promise.then((data) =>
      QueryGetCurrencyResponse.decode(new Reader(data))
    );
  }
  ...
  CurrencyAll(
    ...
    return promise.then((data) =>
      QueryAllCurrencyResponse.decode(new Reader(data))
    );
  }
